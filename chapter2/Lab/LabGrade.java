...
public class LabGrade
{
	public static void main (String[] args)
	{
		...
		System.out.print("Enter the in class weight(In decimal form): ");
		inWeight = scan.nextDouble();
		outWeight = 1 - inWeight;
		System.out.println();
		//Calculate the average for the out of class work
		outClassAvg = (int) ((double) (preLabPts + postLabPts) / (preLabMax + postLabMax) * 100);
		//Calculate the average for the in-class work
		inClassAvg = (int) ((double)labPts / labMax * 100);
